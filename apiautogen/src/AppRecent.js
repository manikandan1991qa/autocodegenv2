...
function App() {
    ...
    // By Default Accordian will be collasped state
    ...
    // By Clicking the arrow button, Accordian state will be changed to expand or collapsed
...
`;
        ...
        var stepDefCode = `import io.cucumber.java.en.*;
...
public class ${capitalize(serviceName)}Steps {
    ...
    private ErrorResponseData errorResponse;`
        ...
        if (requestType == 'GET') {
            stepDefCode += `
    @Given("the user send if  ${requestType.toLowerCase()} request to ${serviceName} service endpoint")
    public void sendRequestToServiceEndpoint() {
        response = ${serviceName.toLowerCase()}.${methodLower}();
    }`;
        } else {
            stepDefCode += `
    @Given("the user send else ${requestType.toLowerCase()} request to ${serviceName} service endpoint")
    public void sendRequestToServiceEndpoint() {
        response = ${serviceName.toLowerCase()}.${methodLower}();
    }`
        }
  ...
  Scenario: Verify error response for ${requestType} request to ${serviceName}
    ...
    const handleData = (data) => {
        ...
        console.log("Headers :: " + data.details.headerValues);
        ...
        setHeaderValue("");
        setHeaders([]);
        setBulkHeaders(JSON.stringify(data.details.headervalues));
        setRequestBody(JSON.stringify(data.details.requestSample));
        ...
        // After setting the data expand the Accordian
        setAccordionState({
            requestBody: true,
